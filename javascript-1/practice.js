...
let me = {firstName: 'spencer', state: 'ut', age: 32, greeter: function(){
...
let doubled = myNumbers.map(elm => elm*2)
...
let forTheLoveOfGeorge = notGeorge.map(function(elm){
	elm = "George"
	return elm
})
...
let totallyAwesome = people.reduce((total,num) => {
	return total + num.awesomeLevel
},0)
